...
<p><strong>초대 역할: ${roleLabel}</strong> · <span class="detail">${roleLabel === 'guardian' ? '연결된 피보호자의 동의한 위치를 확인합니다.' : '본인이 동의해 공유한 위치를 연결된 보호자에게 제공합니다.'}</span></p>
...
<p class="notice">연결만으로 위치 공유가 켜지지는 않습니다. 보호자는 연결된 피보호자의 공유 위치와 이동 기록만 볼 수 있고, 피보호자는 보호자의 위치와 이동 기록을 볼 수 없습니다.</p>
